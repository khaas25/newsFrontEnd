...
export default function TechNews() {
  ...
  useEffect(() => {
    async function getData() {
      var res = await fetch(
        "https://newsapi.org/v2/everything?q=Tech&apiKey=ebecd70bd7d54d23bac375f5e3948872"
      );
  ...
  return (
    <div>
        ...
        <div className="container py-lg-4 py-md-3">
          ...
          <div className="most-recent">
            <div className="title-align mb-4">
              <h3 className="title-left">Tech Industry</h3>
      ...
      <div className="btn-container">
        <Link to="/techNews" className="btn btn-style btn-primary">
          View All Articles
        </Link>
      </div>
    </div>
